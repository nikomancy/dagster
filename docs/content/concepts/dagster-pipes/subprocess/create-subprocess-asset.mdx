...
This is part one of the [Using Dagster Pipes](/guides/dagster-pipes/subprocess) tutorial. If you are looking for how to modify your existing code that is already being orchestrated by Dagster, you can jump to <a href="/concepts/dagster-pipes/subprocess/modify-external-code">Part 2: Modify external code</a>.
